...
#calling setuid file here via echo
echo "Setuid files:"
echo "============="
#using find command to find the files of specific type
...
#calling setgid file here via echo
echo "setgid files:"
echo "============="
#using find command to search the files of specific type
find / -type f -executable -perm -9000 -ls 2>/dev/null | sort -k 9
echo ""
...
#calling top largest regular file here via echo
echo "top largest regular files:"
echo "============="
#using find command to find the files of specific type and size given
find / -type f -executable du-h {} + 2>/dev/null | sort -n -r | head -n 10
echo ""
