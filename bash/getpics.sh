...
#Task1
# using same operation for pics.tgz
#test command to cjheck if the fie exists and wget if file not  found
test -f ~/Pictures/pics.tgz || wget -q -O ~/Pictures/pics.tgz http://zonzorp.net/pics.tgz
#unpack or extracting tgz using tar if the file is found using test commands
